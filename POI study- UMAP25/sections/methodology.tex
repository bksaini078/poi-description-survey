...
The sample demographics were as follows. Ages ranged from 22 to 49 years (M = 30.94, SD = 6.74). Gender distribution included 34 males (67\%) and 17 females (33\%). Nationalities were predominantly Indian (n = 28) and German (n = 21), with Chinese (n = 1) and Iranian (n = 1) representation. Marital status comprised 25 married, 22 single, 3 in relationships, and 1 divorced. Among the 44 participants who reported their profession, backgrounds centered on students (n = 22) and engineers (n = 16), with smaller numbers of academics (n = 3), healthcare professionals (n = 1), government workers (n = 1), and self-employed individuals (n = 1).
